...
const baseUrl = 'https://www.dicesaloonsingles.co.uk';
...
class PriceGetter_DiceSaloon extends AbstractPriceGetter {
    constructor() {
        super({
            name: sellerName,
            region: 'UK',
            logoUrl: '/images/Dice_Saloon_Singles_logo_500x200.png',
...
class DataProcessor_DiceSaloon extends AbstractJsonDataProcessor {
    constructor() {
        super({
            seller: sellerName,
