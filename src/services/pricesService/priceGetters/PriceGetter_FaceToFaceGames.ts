...
const sellerName = 'Face to Face Games';
const baseUrl = 'https://www.facetofacegames.com';

class PriceGetter_FaceToFaceGames extends AbstractPriceGetter {
    constructor() {
        super({
            name: sellerName,
...
class DataGetter_FaceToFaceGames extends AbstractDataGetter {
    constructor() {
        super({
            name: sellerName,
            baseUrl: `${baseUrl}/`,
...
class DataProcessor_FaceToFaceGames extends AbstractJsonDataProcessor {
    constructor() {
        super({
            seller: sellerName,
            ...
            processData: (rawData: any): Price[] => {
                ...
                return products
                    .filter((p: any) => p.type === 'Singles' && p.vendor === 'Magic' && p.available)
                    .map((p: any): Price => {
...
export default PriceGetter_FaceToFaceGames;
