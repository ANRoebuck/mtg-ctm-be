...
const sellerName = 'Gathering Point Games';

class PriceGetter_GatheringPointGames extends AbstractPriceGetter {
    constructor() {
        super({
            name: sellerName,
...
class DataProcessor_GatheringPointGames extends AbstractHtmlDataProcessor {
    constructor() {
        super({
            seller: sellerName,
            ...
            productBaseUrl: 'https://gatheringpointgames.co.uk',
...
export default PriceGetter_GatheringPointGames;
